...
Install recipes with `npx shadcn@latest add` and the JSON URL from each recipe
page, then invoke them through your Eve or Flue project as usual. This site also
